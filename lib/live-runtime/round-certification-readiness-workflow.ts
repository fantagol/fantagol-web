...
const WORKFLOW_TYPE = "round_certification_readiness";
const WORKFLOW_VERSION = 1;
const STEP_KEY = "evaluate_round_certification_readiness";

export type LaunchRoundCertificationReadinessWorkflowInput = {
...
export type LaunchedRoundCertificationReadinessWorkflow = {
  workflowId: string;
...
function buildWorkflowIdempotencyKey(
  input: Pick<
    LaunchRoundCertificationReadinessWorkflowInput,
...
export async function launchRoundCertificationReadinessWorkflow(
  input: LaunchRoundCertificationReadinessWorkflowInput,
): Promise<LaunchedRoundCertificationReadinessWorkflow> {
