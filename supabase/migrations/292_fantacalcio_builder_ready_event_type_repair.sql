...
'R52-R5-R10 / Migration 292 round-simulation event-type compatibility repair: additive Fantacalcio preview extension. Materializes authoritative per-match contributions inside each fixture side. Contributions are derived from the exact canonical scoring expression and reconcile to side points.';
