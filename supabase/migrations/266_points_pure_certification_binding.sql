-- ============================================================================
-- FANTAGOL
-- Migration 259: Points Pure Certified Result Authority Binding
--
-- Purpose:
--   Bind Prediction Resolution final/certified phase to the immutable
--   official match-result certification authority.
--
-- Safety:
--   - fail closed;
--   - certification is true only for an official certification;
--   - source_match_version must equal the exact match version consumed
--     by the calculation run;
--   - no mutation of historical prediction_score_runtime_results;
--   - a new calculation run materializes the new certified lineage.
--
-- R44-R13-D-R1 demonstrated on La Grande Bellezza 2.0:
--   200/200 rows become certified/non-provisional;
--   200/200 scores remain identical;
--   total points remain 601.00.
-- ============================================================================
