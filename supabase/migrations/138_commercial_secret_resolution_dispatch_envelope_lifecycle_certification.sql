-- =============================================================================
-- FANTAGOL
-- Migration: 138_commercial_secret_resolution_dispatch_envelope_lifecycle_certification.sql
-- Milestone: Commercial Secret Resolution Dispatch Envelope Lifecycle
--
-- Purpose:
...
begin
  ...
  if to_regclass('public.commercial_secret_reference_handoff_policies') is null
    ...
    raise exception 'MIGRATION_138_REQUIRES_MIGRATION_133_OBJECTS';
  end if;
  ...
  if to_regclass('public.commercial_secret_resolution_execution_permit_policies') is null
    ...
    raise exception 'MIGRATION_138_REQUIRES_MIGRATION_135_OBJECTS';
  end if;
  ...
  if to_regprocedure(
    ...
    raise exception 'MIGRATION_138_REQUIRES_MIGRATION_133_FUNCTIONS';
  end if;
  ...
  if to_regclass('public.commercial_secret_resolution_dispatch_envelope_policies') is null
    ...
    raise exception 'MIGRATION_138_REQUIRES_MIGRATION_137_OBJECTS';
  end if;
  ...
  if to_regprocedure(
    ...
    raise exception 'MIGRATION_138_REQUIRES_MIGRATION_137_FUNCTIONS';
  end if;
  ...
  if v_envelope_policy.automatic_dispatch_enabled
    ...
    raise exception 'MIGRATION_138_ENVELOPE_POLICY_POSTURE_FAILED';
  end if;
  ...
  if not (
    ...
    raise exception 'MIGRATION_138_HANDOFF_CAPABILITY_MATRIX_DISABLED';
  end if;
  ...
  if v_handoff_policy.automatic_dispatch_enabled
    ...
    raise exception 'MIGRATION_138_UNSAFE_HANDOFF_POLICY';
  end if;
  ...
  v_backend_code := 'migration_138_backend_' || v_suffix;
  v_backend_name := 'Migration 136 Passive Backend ' || upper(v_suffix);
  v_namespace := 'migration_138:opaque:' || v_suffix;
  v_binding_key := 'migration_138:binding:' || v_suffix;
  ...
  v_gateway_request :=
    public.enqueue_commercial_secret_reference_gateway_request(
      'migration_138:gateway_request:'||v_suffix,
      'migration_138:gateway_idempotency:'||v_suffix,
      null,
      null,
      'production',
      v_namespace,
  ...
  if v_gateway_decision.decision_status<>'accepted'
    ...
    raise exception 'MIGRATION_138_GATEWAY_PREREQUISITE_FAILED';
  end if;
  ...
  v_authorization_request :=
    public.enqueue_commercial_secret_reference_authorization_request(
      'migration_138:authorization:'||v_suffix,
      'migration_138:authorization_idempotency:'||v_suffix,
      v_gateway_request.id,
  ...
  if v_authorization_decision.decision_status<>'authorized'
    ...
    raise exception 'MIGRATION_138_AUTHORIZATION_PREREQUISITE_FAILED';
  end if;
  ...
  v_handoff_request :=
    public.enqueue_commercial_secret_reference_handoff_request(
      'migration_138:handoff:'||v_suffix,
      'migration_138:handoff_idempotency:'||v_suffix,
      v_authorization_request.id,
  ...
  if v_handoff_replay.id<>v_handoff_request.id then
    raise exception 'MIGRATION_138_IDEMPOTENT_REPLAY_CREATED_DUPLICATE';
  end if;
  ...
  begin
    ...
    raise exception 'MIGRATION_138_IDEMPOTENCY_CONFLICT_NOT_ENFORCED';
  exception
    when others then
  ...
  if v_handoff_decision.decision_status<>'accepted'
    ...
    raise exception 'MIGRATION_138_HANDOFF_ACCEPTED_PATH_FAILED';
  end if;
  ...
  if v_handoff_decision.dispatch_allowed
    ...
    raise exception 'MIGRATION_138_HANDOFF_DECISION_NOT_PASSIVE';
  end if;
  ...
  if v_handoff_manifest.manifest_status<>'held'
    ...
    raise exception 'MIGRATION_138_HANDOFF_MANIFEST_FAILED';
  end if;
  ...
  if v_handoff_attempt.attempt_type<>'SECRET_RESOLUTION'
    ...
    raise exception 'MIGRATION_138_BLOCKED_ATTEMPT_FAILED';
  end if;
  ...
  v_permit_request :=
    public.enqueue_commercial_secret_resolution_execution_permit_request(
      'migration_138:permit:'||v_suffix,
      'migration_138:permit_idempotency:'||v_suffix,
      v_handoff_request.id,
  ...
  if v_permit_replay.id<>v_permit_request.id then
    raise exception 'MIGRATION_138_PERMIT_REPLAY_CREATED_DUPLICATE';
  end if;
  ...
  begin
    ...
    raise exception 'MIGRATION_138_PERMIT_IDEMPOTENCY_CONFLICT_NOT_ENFORCED';
  exception
    when others then
  ...
  if v_permit_decision.decision_status<>'approved'
    ...
    raise exception 'MIGRATION_138_PERMIT_DECISION_FAILED';
  end if;
  ...
  if v_permit_decision.permit_execution_allowed
    ...
    raise exception 'MIGRATION_138_PERMIT_DECISION_NOT_PASSIVE';
  end if;
  ...
  if v_execution_permit.permit_status<>'issued'
    ...
    raise exception 'MIGRATION_138_NON_EXECUTABLE_PERMIT_FAILED';
  end if;
  ...
  if v_permit_read.effective_permit_status<>'eligible_metadata_only'
    ...
    raise exception
      'MIGRATION_138_INITIAL_EFFECTIVE_STATUS_FAILED status=%, eligibility=%, execution_authorized=%',
  ...
  if v_permit_attempt.attempt_type<>'SECRET_RESOLUTION'
    ...
    raise exception 'MIGRATION_138_PERMIT_OPERATION_BLOCK_FAILED';
  end if;
  ...
  v_envelope_request :=
    public.enqueue_commercial_secret_resolution_dispatch_envelope_request(
      'migration_138:envelope:'||v_suffix,
      'migration_138:envelope_idempotency:'||v_suffix,
  ...
  if v_envelope_replay.id<>v_envelope_request.id then
    raise exception 'MIGRATION_138_ENVELOPE_REPLAY_CREATED_DUPLICATE';
  end if;
  ...
  begin
    ...
    raise exception 'MIGRATION_138_ENVELOPE_IDEMPOTENCY_CONFLICT_NOT_ENFORCED';
  exception
    when others then
  ...
  if v_envelope_decision.decision_status<>'approved'
     ...
     or v_envelope_decision.granted_lifetime_seconds<>1
    ...
    raise exception 'MIGRATION_138_ENVELOPE_DECISION_FAILED';
  end if;
  ...
  if v_envelope_decision.dispatch_allowed
    ...
    raise exception 'MIGRATION_138_ENVELOPE_DECISION_NOT_PASSIVE';
  end if;
  ...
  if v_dispatch_envelope.envelope_status<>'held'
    ...
    raise exception 'MIGRATION_138_NON_DISPATCHABLE_ENVELOPE_FAILED';
  end if;
  ...
  if v_envelope_read.effective_envelope_status<>'held_metadata_only'
    ...
    raise exception
      'MIGRATION_138_INITIAL_ENVELOPE_STATUS_FAILED status=%, current=%, dispatch_authorized=%, execution_authorized=%',
  ...
  if v_envelope_attempt.attempt_type<>'DISPATCH'
    ...
    raise exception 'MIGRATION_138_ENVELOPE_OPERATION_BLOCK_FAILED';
  end if;
  ...
  if v_envelope_read.effective_envelope_status<>'expired'
    ...
    raise exception
      'MIGRATION_138_ENVELOPE_EXPIRY_FAILED status=%, current=%, dispatch_authorized=%, execution_authorized=%',
      v_envelope_read.effective_envelope_status,
      v_envelope_read.metadata_envelope_current,
      v_envelope_read.dispatch_authorized,
      v_envelope_read.execution_authorized;
  ...
  v_envelope_cancellation :=
    public.cancel_commercial_secret_resolution_dispatch_envelope(
      ...
      'migration_138:cancellation:'||v_suffix,
      'TEST_CANCELLATION',
      'Lifecycle certification cancellation after expiry',
      'MIGRATION_138',
      v_corr,
      v_cause,
      '{"temporary":true,"certification":"MIGRATION_138"}'::jsonb
    );
  ...
  if v_envelope_read.effective_envelope_status<>'cancelled'
    ...
    raise exception 'MIGRATION_138_ENVELOPE_CANCELLATION_FAILED';
  end if;
  ...
  if v_envelope_request_count<>1
    ...
    raise exception
      'MIGRATION_138_ENVELOPE_COUNT_ASSERTION_FAILED request=%, idempotency=%, evaluations=%, decision=%, envelope=%, cancellation=%, attempt=%, receipts=%, events=%, replay=%',
  ...
  begin
    ...
    raise exception 'MIGRATION_138_ENVELOPE_POLICY_GUARD_NOT_ENFORCED';
  ...
  begin
    ...
    raise exception 'MIGRATION_138_ENVELOPE_EVALUATION_GUARD_NOT_ENFORCED';
  exception when others then
    if sqlerrm='COMMERCIAL_SECRET_RESOLUTION_DISPATCH_ENVELOPE_IMMUTABLE' then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_ENVELOPE_DECISION_GUARD_NOT_ENFORCED';
  exception when others then
    if sqlerrm='COMMERCIAL_SECRET_RESOLUTION_DISPATCH_ENVELOPE_IMMUTABLE' then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_DISPATCH_ENVELOPE_GUARD_NOT_ENFORCED';
  exception when others then
    if sqlerrm='COMMERCIAL_SECRET_RESOLUTION_DISPATCH_ENVELOPE_IMMUTABLE' then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_ENVELOPE_CANCELLATION_GUARD_NOT_ENFORCED';
  exception when others then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_ENVELOPE_ATTEMPT_GUARD_NOT_ENFORCED';
  exception when others then
    if sqlerrm='COMMERCIAL_SECRET_RESOLUTION_DISPATCH_ENVELOPE_APPEND_ONLY' then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_ENVELOPE_RECEIPT_GUARD_NOT_ENFORCED';
  exception when others then
    if sqlerrm='COMMERCIAL_SECRET_RESOLUTION_DISPATCH_ENVELOPE_APPEND_ONLY' then
  ...
  begin
    ...
    where envelope_request_id=v_envelope_request.id;
    raise exception 'MIGRATION_138_ENVELOPE_EVENT_GUARD_NOT_ENFORCED';
  exception when others then
    if sqlerrm='COMMERCIAL_SECRET_RESOLUTION_DISPATCH_ENVELOPE_APPEND_ONLY' then
  ...
  begin
    insert into public.commercial_secret_resolution_dispatch_envelope_requests(
      ...
      'migration_138:envelope_plaintext:'||v_suffix,
      'migration_138:envelope_plaintext_idem:'||v_suffix,
      ...
      'secret_resolution',1,'received',v_corr,'MIGRATION_138',repeat('a',64),
      '{"api_key":"FORBIDDEN"}'::jsonb
    );
    raise exception 'MIGRATION_138_ENVELOPE_PLAINTEXT_GUARD_NOT_ENFORCED';
  ...
  begin
    insert into public.commercial_secret_resolution_dispatch_envelope_requests(
      ...
      'migration_138:envelope_endpoint:'||v_suffix,
      'migration_138:envelope_endpoint_idem:'||v_suffix,
      v_envelope_policy.id,v_execution_permit.id,v_permit_request.id,v_permit_decision.id,
      'production','platform','platform',v_namespace,'reference_validation',
      'secret_resolution',1,'received',v_corr,'MIGRATION_138',repeat('b',64),
      '{"endpoint":"forbidden.example"}'::jsonb
    );
    raise exception 'MIGRATION_138_ENVELOPE_ENDPOINT_GUARD_NOT_ENFORCED';
  exception when check_violation then
  ...
  begin
    insert into public.commercial_secret_resolution_dispatch_envelope_requests(
      ...
      'migration_138:envelope_probe:'||v_suffix,
      'migration_138:envelope_probe_idem:'||v_suffix,
      v_envelope_policy.id,v_execution_permit.id,v_permit_request.id,v_permit_decision.id,
      'production','platform','platform',v_namespace,'reference_validation',
      'secret_resolution',1,'approved',v_corr,'MIGRATION_138',repeat('c',64),
    ...
    insert into public.commercial_secret_resolution_dispatch_envelope_decisions(
      ...
      'MIGRATION_138','Temporary decision for executable-envelope guard',
    ...
    insert into public.commercial_secret_resolution_dispatch_envelopes(
      ...
      'migration_138:executable_envelope:'||v_suffix,v_probe_envelope_request_id,
      ...
      '{"temporary":true,"guard_probe":true}'::jsonb,'MIGRATION_138'
    );
    raise exception 'MIGRATION_138_EXECUTABLE_ENVELOPE_GUARD_NOT_ENFORCED';
  exception when check_violation then
  ...
  if v_permit_read.effective_permit_status<>'expired'
    ...
    raise exception
      'MIGRATION_138_EXPIRY_FAILED status=%, eligibility=%, execution_authorized=%',
      v_permit_read.effective_permit_status,
      v_permit_read.metadata_eligibility_current,
      v_permit_read.execution_authorized;
  end if;
  ...
  v_permit_revocation :=
    public.revoke_commercial_secret_resolution_execution_permit(
      v_execution_permit.id,
      'migration_138:revocation:'||v_suffix,
      'TEST_REVOCATION',
  ...
  if v_permit_revocation.execution_permit_id<>v_execution_permit.id
    ...
    raise exception 'MIGRATION_138_PERMIT_REVOCATION_FAILED';
  end if;
  ...
  if v_permit_read.effective_permit_status<>'revoked'
    ...
    raise exception
      'MIGRATION_138_REVOKED_EFFECTIVE_STATUS_FAILED status=%, eligibility=%, execution_authorized=%',
      v_permit_read.effective_permit_status,
      v_permit_read.metadata_eligibility_current,
      v_permit_read.execution_authorized;
  end if;
  ...
  if v_permit_request_count<>1
    ...
    raise exception
      'MIGRATION_138_PERMIT_COUNT_ASSERTION_FAILED request=%, idempotency=%, evaluations=%, decision=%, permit=%, revocation=%, attempt=%, receipts=%, events=%, replay=%',
  ...
  begin
    ...
    raise exception 'MIGRATION_138_PERMIT_POLICY_GUARD_NOT_ENFORCED';
  exception
    when others then
  ...
  begin
    ...
    where permit_request_id=v_permit_request.id;
    raise exception 'MIGRATION_138_PERMIT_EVALUATION_GUARD_NOT_ENFORCED';
  exception
    when others then
      if sqlerrm='COMMERCIAL_SECRET_RESOLUTION_EXECUTION_PERMIT_IMMUTABLE' then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_PERMIT_DECISION_GUARD_NOT_ENFORCED';
  exception
    when others then
      if sqlerrm='COMMERCIAL_SECRET_RESOLUTION_EXECUTION_PERMIT_IMMUTABLE' then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_EXECUTION_PERMIT_GUARD_NOT_ENFORCED';
  exception
    when others then
      if sqlerrm='COMMERCIAL_SECRET_RESOLUTION_EXECUTION_PERMIT_IMMUTABLE' then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_PERMIT_REVOCATION_GUARD_NOT_ENFORCED';
  exception
    when others then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_PERMIT_ATTEMPT_GUARD_NOT_ENFORCED';
  exception
    when others then
      if sqlerrm='COMMERCIAL_SECRET_RESOLUTION_EXECUTION_PERMIT_APPEND_ONLY' then
  ...
  begin
    ...
    where permit_request_id=v_permit_request.id;
    raise exception 'MIGRATION_138_PERMIT_RECEIPT_GUARD_NOT_ENFORCED';
  exception
    when others then
      if sqlerrm='COMMERCIAL_SECRET_RESOLUTION_EXECUTION_PERMIT_APPEND_ONLY' then
  ...
  begin
    ...
    where permit_request_id=v_permit_request.id;
    raise exception 'MIGRATION_138_PERMIT_EVENT_GUARD_NOT_ENFORCED';
  exception
    when others then
      if sqlerrm='COMMERCIAL_SECRET_RESOLUTION_EXECUTION_PERMIT_APPEND_ONLY' then
  ...
  begin
    insert into public.commercial_secret_resolution_execution_permit_requests(
      ...
      'migration_138:permit_plaintext:'||v_suffix,
      'migration_138:permit_plaintext_idempotency:'||v_suffix,
      v_permit_policy.id,
      ...
      v_corr,'MIGRATION_138',repeat('d',64),
      '{"api_key":"FORBIDDEN"}'::jsonb
    );
    raise exception 'MIGRATION_138_PERMIT_PLAINTEXT_GUARD_NOT_ENFORCED';
  exception
  ...
  begin
    insert into public.commercial_secret_resolution_execution_permit_requests(
      ...
      'migration_138:permit_endpoint:'||v_suffix,
      'migration_138:permit_endpoint_idempotency:'||v_suffix,
      v_permit_policy.id,
      v_handoff_request.id,v_handoff_decision.id,v_handoff_manifest.id,
      v_authorization_request.id,v_authorization_decision.id,
      'production','platform','platform',v_namespace,
      'reference_validation','secret_resolution',3,'received',
      v_corr,'MIGRATION_138',repeat('e',64),
      '{"endpoint":"forbidden.example"}'::jsonb
    );
    raise exception 'MIGRATION_138_PERMIT_ENDPOINT_GUARD_NOT_ENFORCED';
  exception
    when check_violation then
  ...
  begin
    insert into public.commercial_secret_resolution_execution_permit_policies(
      ...
      'MIGRATION_138','MIGRATION_138',clock_timestamp(),
      '{"temporary":true}'::jsonb
    );
    raise exception 'MIGRATION_138_ACTIVE_POLICY_GUARD_NOT_ENFORCED';
  exception
    when check_violation then
  ...
  if v_read.request_status<>'accepted'
    ...
    raise exception
      'MIGRATION_138_READ_MODEL_FAILED evaluations=%, attempts=%, receipts=%, events=%, replay=%',
  ...
  if v_backend_count<>1
    ...
    raise exception
      'MIGRATION_138_COUNT_ASSERTION_FAILED backend=%, version=%, capabilities=%, binding=%, gateway_request=%, gateway_decision=%, authorization_request=%, authorization_evaluations=%, authorization_decision=%, handoff_request=%, handoff_idempotency=%, handoff_evaluations=%, handoff_decision=%, handoff_manifest=%, handoff_attempt=%, handoff_receipts=%, handoff_events=%, replay=%',
      v_backend_count,
      v_version_count,
      v_capability_count,
      v_binding_count,
  ...
  -- ===========================================================================
  -- 13. IMMUTABILITY AND APPEND-ONLY GUARDS
  -- ===========================================================================
  ...
  begin
    ...
    raise exception 'MIGRATION_138_POLICY_GUARD_NOT_ENFORCED';
  exception
    when others then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_EVALUATION_GUARD_NOT_ENFORCED';
  exception
    when others then
      if sqlerrm='COMMERCIAL_SECRET_REFERENCE_HANDOFF_IMMUTABLE' then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_DECISION_GUARD_NOT_ENFORCED';
  exception
    when others then
      if sqlerrm='COMMERCIAL_SECRET_REFERENCE_HANDOFF_IMMUTABLE' then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_MANIFEST_GUARD_NOT_ENFORCED';
  exception
    when others then
      if sqlerrm='COMMERCIAL_SECRET_REFERENCE_HANDOFF_IMMUTABLE' then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_ATTEMPT_GUARD_NOT_ENFORCED';
  exception
    when others then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_RECEIPT_GUARD_NOT_ENFORCED';
  exception
    when others then
      if sqlerrm='COMMERCIAL_SECRET_REFERENCE_HANDOFF_APPEND_ONLY' then
  ...
  begin
    ...
    raise exception 'MIGRATION_138_EVENT_GUARD_NOT_ENFORCED';
  exception
    when others then
      if sqlerrm='COMMERCIAL_SECRET_REFERENCE_HANDOFF_APPEND_ONLY' then
        v_event_guard:=true;
  ...
  begin
    insert into public.commercial_secret_reference_handoff_requests(
      ...
      'migration_138:plaintext:'||v_suffix,
      'migration_138:plaintext_idempotency:'||v_suffix,
      v_handoff_policy.id,
      v_authorization_request.id,
      v_authorization_decision.id,
      v_gateway_request.id,
    ...
    raise exception 'MIGRATION_138_PLAINTEXT_GUARD_NOT_ENFORCED';
  exception
    when check_violation then
  ...
  begin
    insert into public.commercial_secret_reference_handoff_requests(
      ...
      'migration_138:endpoint:'||v_suffix,
      'migration_138:endpoint_idempotency:'||v_suffix,
      v_handoff_policy.id,
      v_authorization_request.id,
      v_authorization_decision.id,
      v_gateway_request.id,
    ...
    raise exception 'MIGRATION_138_ENDPOINT_GUARD_NOT_ENFORCED';
  exception
    when check_violation then
  ...
  begin
    insert into public.commercial_secret_reference_handoff_requests(
      ...
      'migration_138:executable_probe:'||v_suffix,
      'migration_138:executable_probe_idempotency:'||v_suffix,
      v_handoff_policy.id,
      v_authorization_request.id,
      v_authorization_decision.id,
      v_gateway_request.id,
    ...
    insert into public.commercial_secret_reference_handoff_manifests(
      ...
      'migration_138:executable:'||v_suffix,
      v_probe_handoff_request_id,
    ...
    raise exception 'MIGRATION_138_EXECUTABLE_MANIFEST_GUARD_NOT_ENFORCED';
  exception
    when check_violation then
  ...
  if not (
    ...
    raise exception 'MIGRATION_138_GUARD_MATRIX_FAILED';
  end if;

  -- ===========================================================================
  -- 15. ECONOMIC/RUNTIME NON-MUTATION
  -- ===========================================================================
  ...
  if v_purchase_after<>v_purchase_before
    ...
    raise exception 'MIGRATION_138_ECONOMIC_NON_MUTATION_FAILED';
  end if;
...
\echo ''
\echo 'MIGRATION_138_TRANSACTION_ROLLED_BACK'
\echo 'No temporary backend, capability, binding, gateway object, authorization object, handoff object, execution-permit object, dispatch-envelope object, cancellation, revocation, policy change, purchase, checkout, wallet, ledger or outbox mutation was persisted.'
