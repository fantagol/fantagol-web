-- ============================================================================
-- FANTAGOL
-- Migration 043: Fantacalcio Preview Payload Contract Hotfix
--
-- Fix:
--   - expose active schedule identity/version in the Fantacalcio Preview payload;
--   - expose a stable fixture status ('complete', 'pending', 'bye') while
--     preserving the more specific fixture_phase;
--   - keep fixture counters and payload semantics aligned for client/read-model use.
-- ============================================================================
...
'Builds a new immutable Round Simulation derived from a ready Points Preview. Consumes only Fantacalcio fixtures from the active League Schedule Version and exposes schedule provenance plus stable fixture status in the preview payload. Service-role only.';
