-- ============================================================================
-- FANTAGOL - MIGRATION 295
-- FANTACALCIO SHARED SIMULATION VERSION LOCK REPAIR
-- R54-R15
--
-- Root cause:
-- build_fantacalcio_preview_simulation_rpc was redefined after migration 248
-- with the legacy builder-specific advisory lock:
--
--   <league_round_id>:fantacalcio-preview
--
-- while the other Round Simulation builders serialize MAX(simulation_version)+1
-- on the canonical shared authority:
--
--   round-simulation-version:<league_round_id>
--
-- This reintroduced a cross-builder race and caused the G2 final-calculable
-- rebuild to dead-letter on round_simulations_round_version_unique at v329.
--
-- Contract:
-- - restore the migration 248 shared version-allocation lock;
-- - do not change Fantacalcio scoring, strategies, forfeit authority or payloads;
-- - do not change Points, One-to-One, Standings or UI Snapshot builders;
-- - no frontend changes.
-- ============================================================================
