-- ============================================================================
-- FANTAGOL MIGRATION 320
-- R116 END_PENDING TERMINAL PROJECTION
--
-- END_PENDING means:
-- - Tutto has stopped operational LIVE polling;
-- - Football-Data official FINISHED/AWARDED confirmation is still pending.
--
-- It must therefore NOT be materialized as actively-playing live_second_half.
--
-- Projection only:
--   status       = paused
--   period       = PAUSED
--   minute       = preserved live_authority_minute
--   result_phase = live (unchanged provisional scoring contract)
--
-- Official final authority remains unchanged.
-- ============================================================================
BEGIN;
...
COMMENT ON FUNCTION public.build_points_preview_simulation_rpc IS
'R116/M320: END_PENDING materializes as paused/PAUSED with preserved authority minute while result_phase remains live; official final still requires FINISHED/AWARDED authority.';
