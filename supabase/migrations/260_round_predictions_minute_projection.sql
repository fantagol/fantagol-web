...
returns table (
  ...
  kickoff timestamptz, match_status text,
  minute integer, home_score integer, away_score integer,
...
begin
  ...
  select
    ...
    v_member, frm.slot_number, frm.required, m.id, m.kickoff, m.status, m.minute,
