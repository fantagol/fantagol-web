-- ============================================================================
-- FANTAGOL
-- Migration 267: Round Certification JSONB Empty-Object Gate Hotfix
--
-- Purpose:
--   Repair certify_round_rpc use of nonexistent jsonb_object_length(jsonb).
--
-- Semantic replacement:
--   jsonb_object_length(v_standings_snapshot -> 'modes') = 0
-- becomes:
--   (v_standings_snapshot -> 'modes') = '{}'::jsonb
--
-- Safety:
--   - one surgical expression replacement only;
--   - preserves standings_snapshot object/type gates;
--   - no table/schema mutation;
--   - no historical certification mutation by migration itself;
--   - no publication/job enqueue.
-- ============================================================================
