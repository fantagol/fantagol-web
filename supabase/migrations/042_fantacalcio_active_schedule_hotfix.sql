-- ============================================================================
-- FANTAGOL
-- Migration 042: Fantacalcio Active Schedule Version Hotfix
--
-- Fix:
--   - Fantacalcio Preview Builder must consume only fixtures belonging to the
--     active League Schedule Version;
--   - historical schedule fixtures remain preserved but excluded from previews;
--   - active schedule identity/version becomes part of deterministic input hash.
-- ============================================================================
...
'Builds a new immutable Round Simulation derived from a ready Points Preview. Consumes only Fantacalcio fixtures from the active League Schedule Version, applies submitted 5 Attack / 5 Defense Strategy Snapshots, and stores final points, goals and fixture result. Service-role only.';
